...
var _JordyMoos$elm_clockpicker$ClockPicker$formatHour = function (hour) {
	...
	if (_p0 === 24) {
		...
		return _elm_lang$core$Basics$toString(hour);
	}
};
var _JordyMoos$elm_clockpicker$ClockPicker$formatMinuteFull = function (minute) {
	return _elm_lang$core$Native_Utils.eq(minute, 60) ? '00' : ((_elm_lang$core$Native_Utils.cmp(minute, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(minute)) : _elm_lang$core$Basics$toString(minute));
};
var _JordyMoos$elm_clockpicker$ClockPicker$formatMinute = function (minute) {
	var _p1 = minute;
	if (_p1 === 60) {
		return '00';
	} else {
		return _elm_lang$core$Basics$toString(minute);
	}
};
...
var _JordyMoos$elm_clockpicker$ClockPicker$offsetPosition = A3(
	_elm_lang$core$Json_Decode$map2,
	_elm_lang$mouse$Mouse$Position,
...
var _JordyMoos$elm_clockpicker$ClockPicker$outerRadius = 80.0;
...
var _JordyMoos$elm_clockpicker$ClockPicker_ops = _JordyMoos$elm_clockpicker$ClockPicker_ops || {};
_JordyMoos$elm_clockpicker$ClockPicker_ops['!'] = F2(
	function (model, cmds) {
		return {
			ctor: '_Tuple3',
			_0: _JordyMoos$elm_clockpicker$ClockPicker$ClockPicker(model),
...
var _JordyMoos$elm_clockpicker$ClockPicker$DragAt = function (a) {
...
var _JordyMoos$elm_clockpicker$ClockPicker$drawMinuteTicks = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('clockpicker-dial clockpicker-minutes'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('clockpicker-plate'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('hand-target'),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _JordyMoos$elm_clockpicker$ClockPicker$drawMinuteTicks(model),
					_1: {
						ctor: '::',
						_0: _JordyMoos$elm_clockpicker$ClockPicker$drawMinuteCanvas(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var _JordyMoos$elm_clockpicker$ClockPicker$drawHourTicks = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('clockpicker-dial clockpicker-hours'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _JordyMoos$elm_clockpicker$ClockPicker$drawHourTicks(model),
					_1: {
						ctor: '::',
						_0: _JordyMoos$elm_clockpicker$ClockPicker$drawHourCanvas(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var _JordyMoos$elm_clockpicker$ClockPicker$ClosePicker = {ctor: 'ClosePicker'};
var _JordyMoos$elm_clockpicker$ClockPicker$drawHourView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('popover clockpicker-popover bottom clockpicker-align-left'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _JordyMoos$elm_clockpicker$ClockPicker$viewTitle(model),
				_1: {
					ctor: '::',
					_0: _JordyMoos$elm_clockpicker$ClockPicker$viewPopoverContentHour(model),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('btn btn-sm btn-default btn-block clockpicker-button'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_JordyMoos$elm_clockpicker$ClockPicker$ClosePicker),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _JordyMoos$elm_clockpicker$ClockPicker$drawMinuteView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _JordyMoos$elm_clockpicker$ClockPicker$viewPopoverContentMinute(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
...
var _JordyMoos$elm_clockpicker$ClockPicker$clockPickerWrapper = function (model) {
	...
	switch (_p9.ctor) {
		...
		case 'HourView':
			return _JordyMoos$elm_clockpicker$ClockPicker$drawHourView(model);
		default:
			return _JordyMoos$elm_clockpicker$ClockPicker$drawMinuteView(model);
	}
};
...
var _JordyMoos$elm_clockpicker$ClockPicker$view = function (_p10) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('clockpicker-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_JordyMoos$elm_clockpicker$ClockPicker$OpenPicker),
					_1: {
						ctor: '::',
...
var _JordyMoos$elm_clockpicker$Simple$Model = F2(
	function (a, b) {
		return {time: a, clockPicker: b};
	});
var _JordyMoos$elm_clockpicker$Simple$ToClockPicker = function (a) {
...
var _JordyMoos$elm_clockpicker$Simple$init = function () {
	...
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{time: _elm_lang$core$Maybe$Nothing, clockPicker: clockPicker},
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _JordyMoos$elm_clockpicker$Simple$ToClockPicker, clockPickerCmd),
			_1: {ctor: '[]'}
		});
}();
var _JordyMoos$elm_clockpicker$Simple$update = F2(
	function (msg, _p1) {
		var _p2 = _p1;
		var _p6 = _p2;
		var _p3 = msg;
		var _p4 = A2(_JordyMoos$elm_clockpicker$ClockPicker$update, _p3._0, _p2.clockPicker);
		var newClockPicker = _p4._0;
		var clockPickerCmd = _p4._1;
		var newTime = _p4._2;
		var time = function () {
			var _p5 = newTime;
			if (_p5.ctor === 'Nothing') {
		...
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				_p6,
				{time: time, clockPicker: newClockPicker}),
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _JordyMoos$elm_clockpicker$Simple$ToClockPicker, clockPickerCmd),
				_1: {ctor: '[]'}
...
var _JordyMoos$elm_clockpicker$Simple$view = function (_p7) {
	var _p8 = _p7;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: function () {
				...
				if (_p9.ctor === 'Nothing') {
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Pick a time'),
							_1: {ctor: '[]'}
						});
				} else {
					var _p10 = _p9._0;
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(_p10.hour),
										A2(
											_elm_lang$core$Basics_ops['++'],
											' and minute: ',
											_elm_lang$core$Basics$toString(_p10.minute))))),
							_1: {ctor: '[]'}
						});
				}
			}(),
			_1: {
				...
				_0: A2(
					...
					_JordyMoos$elm_clockpicker$Simple$ToClockPicker,
					_JordyMoos$elm_clockpicker$ClockPicker$view(_p8.clockPicker)),
				_1: {ctor: '[]'}
			}
		});
};
var _JordyMoos$elm_clockpicker$Simple$main = _elm_lang$html$Html$program(
	{
		init: _JordyMoos$elm_clockpicker$Simple$init,
		update: _JordyMoos$elm_clockpicker$Simple$update,
		view: _JordyMoos$elm_clockpicker$Simple$view,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Simple'] = Elm['Simple'] || {};
if (typeof _JordyMoos$elm_clockpicker$Simple$main !== 'undefined') {
    _JordyMoos$elm_clockpicker$Simple$main(Elm['Simple'], 'Simple', undefined);
}
